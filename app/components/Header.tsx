  ...
  return (
    <header className="w-full border-b border-gray-700 px-4 sm:px-6 py-3 sm:py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 sm:gap-3 cursor-pointer hover:opacity-80 transition-opacity duration-200">
          <Image src={AppIcon} alt="App icon" width={32} height={32} />
          <h1 className="text-lg sm:text-2xl font-bold bg-linear-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
            CleanText
          </h1>
        </Link>

        <div className="flex items-center gap-2 sm:gap-4">
          <PWAInstallButton isDark={isDark} variant="header" />
          <Button
